...
if (empty($_SESSION['id']) || $time + 3600 > time()) {
    header('Location: login.php');
    exit();
}
$member = fetchMember($db);

$message = $_POST['message'] ?? null;

if ($message) {
    $reply_post_id = $_POST['reply_post_id'] ?? 0;
//    $reply_post_id = $_POST['reply_post_id'] ?: 0;
...
<div id="wrap">
  ...
  <div id="content">
    ...
    <?php foreach ($posts as $post): ?>
        <div class="msg"><img src="member_picture/<?php print(htmlspecialchars($post['picture'], ENT_QUOTES)); ?>" width="48" height="48" alt="<?php print(htmlspecialchars($post['name'], ENT_QUOTES)); ?>" />
